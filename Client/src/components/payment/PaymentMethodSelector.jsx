        ...
        {methods.map((method) => (
          <button
            ...
            className={`relative rounded-xl border-2 p-4 text-left transition-all ${
              selected === method.id
                ? 'border-gold-500 ring-2 ring-gold-500/30 shadow-md'
          ...
          >
            ...
            {selected === method.id && (
              <span className="absolute top-3 right-3 flex h-5 w-5 items-center justify-center rounded-full bg-gold-500 text-charcoal">
