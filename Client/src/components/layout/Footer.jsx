        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-gold-400 text-white font-display text-xl font-bold">
                F
              </span>
              <span className="font-display text-2xl font-semibold">FMG Catering</span>
            </div>
            <p className="text-white/70 text-sm leading-relaxed">
              Premium catering services for weddings, corporate events, and special celebrations.
          ...
          <div>
            ...
            <p className="text-sm text-white/50 mt-4">
              Staff portal access available for authorized personnel only.
            </p>
          </div>
        </div>
